      ...
      <div class="container">
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build times-saas-manager
<span># Test</span>
nx test times-saas-manager
<span># Lint</span>
nx lint times-saas-manager
<span># Run them together!</span>
nx run-many -p times-saas-manager -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project times-saas-manager</pre>
          </details>
